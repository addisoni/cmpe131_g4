...
[//]: # (PROJECT LOGO)
<p align="center"> 
  <img src="https://github.com/addisoni/cmpe131_g4/blob/main/images/readme/foldertastic_logo.png" alt="Logo" width="250" height="250">
</p>
...
<details>
  ...
  4. [folders Functions](#folders-functions)
     - [Creating folders](#creating-folders)
     - [Adding different typefaces and font styles](#adding-different-typefaces-and-font-styles)
     - [Searching for folders](#searching-for-folders)
     - [Sorting folders](#sorting-folders)
...
foldertastic is a web-based folder taking app that utilizies Flask-Login, Flask-SQLAlchemy, Flask-WTF, and various other
extensions to provide the user with an easy and simple way to save their thoughts and ideas online. As a user, you will
be able to do basic things such as creating your own personal account, creating and modifying your folders with different 
typefaces and font styles, have the ability to share them to the public or keep it private, and so much more!

### Built With:
* [![Flask][Flask.com]][Flask-url]
  
[back to top](#foldertastic)
...
Make sure you have the following libraries installed before running foldertastic:<br>
...
### Creating folders
1. After logging in, you will be redirected to the folders creation page where you can create new folders
<p align="center"> 
  <img src="https://github.com/addisoni/cmpe131_g4/blob/main/images/readme/folderPage.png" alt="Logo" width="1051" height="452">
</p>

2. To save the folder after inputting the title and body, click on "**Save folder**"

3. After saving, you will be redirected to the home page where you can view, delete, modify, or change the folder's visibility to other users.

4. To create another new folder, click the "**folders**" tab on the menu bar and do the same thing as mentioned in step 2
...
2. You can search for folders containing the title or body that you inputted as shown below
<p align="center"> 
  ...
  <img src="https://github.com/addisoni/cmpe131_g4/blob/main/images/readme/folderContents.png" alt="Logo" width="430" height="426">
</p>
...
<p align="center"> 
  <img src="https://github.com/addisoni/cmpe131_g4/blob/main/images/readme/folderSort.png" alt="Logo" width="630" height="533">
</p>
...
1. folders created on webpage are restricted to corresponding user and can change visiblity based on user's selection **(Benjamin Lim)** 
...
4. Create new folders **(Addison Ivan)**
...
8. Multiple folder sorting options **(Addison Ivan)**

9. Search field for folders list **(Addison Ivan)**
